...
function ConsultaAltasybajas({NumCuenta,Periodo}) {
    ...
    return ( <>
                            {(!loading&&!error.error)&&<>
                             <EfectoLetrasTitulo titulo={"Comprobante de altas y bajas"}/>
                                    ...
                                    <div className="card-body">
                                        ...
                                        <table className="table table-hover table-bordered table-sm">
                                            ...
                                            <tbody>
                                                ...
                                                {materias.map(({IDmateria,Nombre,Grupo,Creditos,Semestre,Movimiento})=>{
                                                    return <tr>
                             ...
                             {btnPdf&&<BotonPdf name={"Altas y bajas"} infoAlumno={{alumno:infoAlumno,materias:materias}}/>}
                             </>}
                             {
...
export default ConsultaAltasybajas;